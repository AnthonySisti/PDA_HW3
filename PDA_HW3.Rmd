...
This causes us to drop 48 total participants from the study, leaving us with 867 pain observations on 157 unique individuals. We compare the summary statistics for the dropped patients and the remaining patients to justify this removal. 
...
#establish which ID values are present before final NA removal
...
#Test additional model combinations
...
#Estabish best model at start of testing
...
#Check residuals through regression diagnostics

car::qqPlot(resid(Good_Model), ylab = "Model Residuals", main = "QQ plot for Normality of Within-Person Residuals")  #QQ plot for normality of within-person residuals 
...
#Filter data so it only includes MN
#89 obs
...
#determine whether to use basement of bulding type
...
#QQ plot for normality of within-personresiduals 
...
#Take complete cases from data set with all states
